...
description: "Domain-specific components like PropertyCard, AgentCard, DevelopmentCard, and PropertyGallery accept typed props and handle display logic without direct data fetching."
---
