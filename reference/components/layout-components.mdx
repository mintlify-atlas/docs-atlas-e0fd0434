---
title: "App layout components: header, navbar, footer, and shell"
sidebarTitle: "Layout Components"
description: "App* layout components build the site shell: header, navbar, footer, mobile menu, language switcher, and logo. All read agency data via useSiteConfig()."
---
