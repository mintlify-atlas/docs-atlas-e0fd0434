---
title: "usePageSeo() and useJsonLd(): per-page SEO setup"
sidebarTitle: "usePageSeo"
description: "usePageSeo() sets per-page title, description, canonical URL, Open Graph, and Twitter meta. useJsonLd() injects schema.org structured data as a JSON-LD script block."
---
...
| `/properties/[slug]` | `RealEstateListing` | Detail page; availability mapped from `PropertyStatus`; `floorSize` with UN/CEFACT unit code |
