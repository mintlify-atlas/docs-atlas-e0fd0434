...
description: "Returns the active SiteConfig (agency identity plus resolved ThemeConfig) via Nuxt useState. SSR-safe and reactive; never import siteConfig directly."
---
