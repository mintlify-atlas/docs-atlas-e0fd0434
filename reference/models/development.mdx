---
title: "Development data model for new-build project listings"
sidebarTitle: "Development"
description: "Domain model for new-build projects. Covers DevelopmentStatus union, price range, area range, delivery date, and per-record sizeUnit fallback."
---
